			...
			<div class="row">
				...
				<div class="col-md-4 log-icons text-right">
					...
					<ul class="social_list1 mt-3">
						...
						<li>
							<a  href="agali awamu disabled and vulnerable persons organization" class="facebook1 mx-2" >
								<i class="fab fa-facebook-f"></i>

							</a>
						</li>
						<li>
							<a href="@advpo_ug" class="twitter2">
								<i class="fab fa-twitter"></i>

							</a>
						</li>
						<li>
							<a href="agali awamu disabled" class="dribble3 mx-2">
								<i class="fab fa-instagram"></i>
							</a>
						</li>
						<li>
							<a href="agali awamu disabled and vulnerable organization" class="pin">
