...
<body>
	...
	<section class="main-content-w3layouts-agileits">
		...
		<div class="contact-map inner-sec">
			...
			<img src="images/aa.png" class="img-rounded" style="width: 1010px; height: 500px;"/>
						...
						<div class="col-lg-4 address-grid">
							<div class="row address-info">
								...
								<div class="col-md-8 address-right text-left">
									<h6>Email</h6>
									<p>
										<a href="mailto:adepea13@gmail.com">info(at)advpo.org</a></p>
									</div>
							...
							<div class="col-lg-4 address-grid">
								<div class="row address-info">
									...
									<div class="col-md-8 address-right text-left">
										...
										<p>+256 (0) 755 943 300</p>
										<p>+256 (0) 782 543 449</p>
										<p>+256 (0) 783 166 215</p>
									</div>
